...
const Project = ({ item }) => {
  ...
  const handleOpenModal = async () => {
    ...
    try {
      ...
      const response = await axios.get(`${URLApi}api/v1/user/${item?.id}`);
        ...
        <div className="profile">
          <div className="link">
            <input
              ...
              className="protofile-link"
              type="text"
              enable
              value="https://www.verited.com/student/profile"
              readOnly
            />
        ...
        <div className="faq-content">
          <Collapse className="colap" size="large" ghost>
            <Collapse.Panel
              ...
              key="1"
            >
              <p style={{ fontSize: 20, fontWeight: 500, color: "#2E2C2C" }}>
                {text}
              </p>
            </Collapse.Panel>
          </Collapse>
